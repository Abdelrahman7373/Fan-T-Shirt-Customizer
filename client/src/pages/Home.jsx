        ...
        <motion.section className="home" {...slideAnimation("left")}>
          ...
          <motion.div className="home-content" {...headContainerAnimation}>
            ...
            <motion.div {...headContentAnimation} className="flex flex-col gap-5">
              <p className="max-w-md font-normal text-gray-600 text-base">Create your unique and exclusive t-shirt with our brand new 3D customization tool. <strong>Unleash your imagination</strong>{" "} and make your own style.</p>
